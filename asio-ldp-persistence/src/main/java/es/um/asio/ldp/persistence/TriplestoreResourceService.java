...
import static es.um.asio.ldp.persistence.TriplestoreUtils.OBJECT;
import static es.um.asio.ldp.persistence.TriplestoreUtils.PREDICATE;
import static es.um.asio.ldp.persistence.TriplestoreUtils.SUBJECT;
import static es.um.asio.ldp.persistence.TriplestoreUtils.asJenaDataset;
import static es.um.asio.ldp.persistence.TriplestoreUtils.getInstance;
import static es.um.asio.ldp.persistence.TriplestoreUtils.getObject;
